                ...
                <div class="modal-body">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="price" class="form-control" placeholder="4.99" required min="0">
                        </div>
                        <div class="form-group">
                            <label>Google Product SKU</label>
                            <input type="text" name="google_product_id" class="form-control" placeholder="com.dating.coins_100" required>
                        </div>
                    </div>
                </div>
